...
/**
 * print_error - print error mess
 * @info: return info struct and parametre
 * @estr: string containing error type
 * Return:  when no numbers in string 0, otherwise
 *        -1 on error
 */
...
/**
 * print_d - function that prints a decimal int num base 10
 * @input: input
 ...
 * @buf: the string address to modify
 *
 * Return: 0;
 */
