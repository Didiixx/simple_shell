...
/**
 * _memset - will fills the memory with a constant byte
...
/**
 * ffree - will frees a string of strings
...
/**
 * _realloc - will reallocates the block of memory
 ...
 *
 * Return: a pointer to the block name.
 */
